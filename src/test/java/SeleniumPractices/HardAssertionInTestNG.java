...
public class HardAssertionInTestNG {
	...
	public void loginTestUsingDataProvider() {
		...
		assertEquals(loginMsg, expectedResult, "User not loged in successfully");
		
		System.out.println("After first verification");
		//assertEquals(thankYouText, expectedResule1,"Message is not matched");
		assertTrue(thankYouText.trim().equalsIgnoreCase(expectedResule1));
		...
		// assertFalse(expectedResult.equals(loginMsg), "User not loged in
		// successsfully");
